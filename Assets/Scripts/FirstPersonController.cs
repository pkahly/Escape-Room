...
namespace UnityStandardAssets.Characters.FirstPerson
{
    ...
    public class FirstPersonController : MonoBehaviour
    {
        ...
        public void SetRunEnabled(bool runEnabled)
        {
        ...
        private void UpdateCameraPosition(float speed)
        {
            ...
            if (isCrouching)
            {
                newCameraPosition.y = 0.2f;
            }
            else
            {
                newCameraPosition.y = 1f;
            }
        ...
        private void GetInput(out float speed)
        {
            ...
            if (!runEnabled || isCrouching)
            {
                // Running is not allowed. Must walk.
                m_IsWalking = true;
            }

            // set the desired speed to be crouching, walking or running
            if (isCrouching)
            {
                speed = m_CrouchSpeed;
            }
